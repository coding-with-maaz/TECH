...
@section('title', 'Login - HARPALJOB TECH')
...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8" style="background: linear-gradient(to bottom right, #1a1a1a, #0d0d0d, #000000);">
    <div class="max-w-md w-full space-y-8">
        ...
        <form class="mt-8 space-y-6 bg-bg-card p-8 rounded-lg shadow-xl" action="{{ route('login') }}" method="POST">
            @csrf
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="{{ route('password.request') }}" class="font-medium text-accent hover:text-accent-light transition-colors">
                        Forgot password?
                    </a>
                </div>
            </div>
