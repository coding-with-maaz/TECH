...
<div class="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div class="bg-gradient-to-br from-accent to-accent-dark text-white p-6 rounded-lg shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-accent-light text-sm mb-1" style="font-family: 'Poppins', sans-serif; font-weight: 500;">Total Categories</p>
                    <p class="text-3xl font-bold" style="font-family: 'Poppins', sans-serif; font-weight: 800;">{{ number_format($totalCategories) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-6 rounded-lg shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm mb-1" style="font-family: 'Poppins', sans-serif; font-weight: 500;">Total Articles</p>
                    <p class="text-3xl font-bold" style="font-family: 'Poppins', sans-serif; font-weight: 800;">{{ number_format($totalArticles) }}</p>
                </div>
                <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-6 rounded-lg shadow-lg">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-purple-100 text-sm mb-1" style="font-family: 'Poppins', sans-serif; font-weight: 500;">Total Views</p>
                    <p class="text-3xl font-bold" style="font-family: 'Poppins', sans-serif; font-weight: 800;">{{ number_format($totalViews) }}</p>
                </div>
                <div class="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
