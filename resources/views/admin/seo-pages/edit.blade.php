...
@section('title', 'Edit SEO Page - Admin')
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        ...
        <p class="text-gray-600 dark:!text-text-secondary mt-1" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
            Update SEO settings for {{ $seoPage->page_name }}
        </p>
    </div>

    <form action="{{ route('admin.seo-pages.update', $seoPage) }}" method="POST" class="bg-white dark:!bg-bg-card rounded-lg border border-gray-200 dark:!border-border-secondary p-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-6">
            ...
            <input type="text" value="{{ $seoPage->page_key }}" disabled class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-gray-100 dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-gray-400" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
            <p class="mt-1 text-xs text-gray-500 dark:!text-text-secondary">Page key cannot be changed after creation</p>
        </div>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="page_name" value="{{ old('page_name', $seoPage->page_name) }}" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
            @error('page_name')
        ...
        <div class="mb-8">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="meta_title" value="{{ old('meta_title', $seoPage->meta_title) }}" maxlength="255" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
        ...
        <div class="mb-8">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" name="og_title" value="{{ old('og_title', $seoPage->og_title) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                </div>
                ...
                <div>
                    ...
                    <textarea name="og_description" rows="3" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 400;">{{ old('og_description', $seoPage->og_description) }}</textarea>
                </div>
        ...
        <div class="mb-8">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="twitter_title" value="{{ old('twitter_title', $seoPage->twitter_title) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                </div>
                ...
                <div>
                    ...
                    <input type="url" name="twitter_image" value="{{ old('twitter_image', $seoPage->twitter_image) }}" placeholder="https://example.com/image.jpg" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                </div>
            </div>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="url" name="canonical_url" value="{{ old('canonical_url', $seoPage->canonical_url) }}" placeholder="https://example.com/page" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-accent focus:border-transparent dark:!bg-bg-card-hover dark:!border-border-primary dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                </div>
        ...
        <div class="mb-6">
            <label class="flex items-center gap-2">
                <input type="checkbox" name="is_active" value="1" {{ old('is_active', $seoPage->is_active) ? 'checked' : '' }} class="w-4 h-4 text-accent border-gray-300 rounded focus:ring-accent">
