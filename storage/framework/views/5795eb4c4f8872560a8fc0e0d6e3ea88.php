...
<?php $__env->startSection('title', 'Admin - Category Management'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex gap-3">
            ...
            <a href="<?php echo e(route('admin.categories.create')); ?>" class="px-4 py-2 bg-accent hover:bg-accent-light text-white rounded-lg transition-colors" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                Add New Category
            </a>
        </div>
    </div>
                ...
                <div class="flex items-start justify-between mb-4">
                    ...
                    <?php if($category->image): ?>
                        <div class="w-16 h-16 rounded overflow-hidden bg-gray-200 dark:!bg-gray-700 flex-shrink-0 ml-4">
                            ...
                            ?>
                            <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($category->name); ?>" class="w-full h-full object-cover" onerror="this.src='https://via.placeholder.com/100?text=No+Image'">
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="flex items-center gap-4 mb-4">
                    <div>
                        ...
                        <p class="text-lg font-bold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 700;">
                            <?php echo e(number_format($category->articles_count)); ?>
                    ...
                    <?php if($category->color): ?>
                        <div>
                            ...
                            <div class="w-8 h-8 rounded" style="background-color: <?php echo e($category->color); ?>"></div>
                        </div>
                    <?php endif; ?>
                </div>

                <div class="flex items-center gap-2 pt-4 border-t border-gray-200 dark:!border-border-secondary">
                    <a href="<?php echo e(route('admin.categories.edit', $category)); ?>" class="flex-1 px-4 py-2 bg-accent hover:bg-accent-light text-white text-center rounded-lg transition-colors text-sm" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        Edit
                    </a>
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-full text-center py-12">
                <p class="text-gray-600 dark:!text-text-secondary mb-4" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                    No categories found. <a href="<?php echo e(route('admin.categories.create')); ?>" class="text-accent hover:underline">Create your first category</a>
                </p>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox - Copy\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>