...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title><?php echo e($seo['title'] ?? 'Tech Blog - Articles & Tutorials'); ?></title>
    <meta name="title" content="<?php echo e($seo['title'] ?? 'Tech Blog - Articles & Tutorials'); ?>">
    ...
    <meta name="keywords" content="<?php echo e($seo['keywords'] ?? 'tech blog, programming, tutorials, technology, articles, web development, software'); ?>">
    <meta name="author" content="<?php echo e($seo['author'] ?? 'Tech Blog'); ?>">
    ...
    <meta property="og:title" content="<?php echo e($seo['og_title'] ?? $seo['title'] ?? 'Tech Blog - Articles & Tutorials'); ?>">
    ...
    <meta property="og:image:alt" content="<?php echo e($seo['title'] ?? 'Tech Blog'); ?>">
    ...
    <meta name="twitter:title" content="<?php echo e($seo['twitter_title'] ?? $seo['title'] ?? 'Tech Blog - Articles & Tutorials'); ?>">
    ...
    <meta name="twitter:image:alt" content="<?php echo e($seo['twitter_title'] ?? $seo['title'] ?? 'Tech Blog'); ?>">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center space-y-4">
                ...
                <p class="text-gray-600 text-sm dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                    Copyright © <?php echo e(date('Y')); ?> - Tech Blog
                </p>
            </div>
        </div>
    </footer>
