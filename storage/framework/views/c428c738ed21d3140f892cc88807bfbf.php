...
<?php $__env->startSection('title', 'About Us - Tech Blog'); ?>
...
<div class="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-8">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white dark:!bg-bg-card border border-gray-200 dark:!border-border-secondary rounded-lg p-6 md:p-8 space-y-6" style="font-family: 'Poppins', sans-serif;">
            ...
            <section>
                <p class="text-gray-700 dark:!text-text-secondary leading-relaxed mb-4" style="font-weight: 400;">
                    Have questions or suggestions? We'd love to hear from you! Feel free to <a href="<?php echo e(route('contact')); ?>" class="text-accent hover:text-accent-light underline" style="font-weight: 600;">contact us</a> with your feedback, article ideas, or any inquiries.
                </p>
            </section>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox - Copy\resources\views/pages/about.blade.php ENDPATH**/ ?>