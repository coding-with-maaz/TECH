...
<?php $__env->startSection('title', 'Categories - Tech Blog'); ?>
...
<div class="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-8">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <?php $__currentLoopData = $featuredCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $featured): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('categories.show', $featured->slug)); ?>" class="group relative overflow-hidden rounded-lg bg-gradient-to-br from-gray-800 to-gray-900 text-white p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                    <?php if($featured->image): ?>
                        ...
                        <div class="absolute inset-0 opacity-20 group-hover:opacity-30 transition-opacity">
                            <img src="<?php echo e($imageUrl); ?>" alt="<?php echo e($featured->name); ?>" class="w-full h-full object-cover" onerror="this.style.display='none'">
                        </div>
                    <?php endif; ?>
    ...
    <div class="bg-white border border-gray-200 rounded-lg p-6 mb-6 dark:!bg-bg-card dark:!border-border-secondary">
        <form method="GET" action="<?php echo e(route('categories.index')); ?>" class="flex flex-col md:flex-row gap-4">
            <!-- Search -->
            <div class="flex-1">
                <input type="text" 
                       name="search" 
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('categories.show', $category->slug)); ?>" class="group bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 dark:!bg-bg-card dark:!border-border-secondary">
                <!-- Category Image/Color Header -->
                <div class="relative h-32 overflow-hidden" style="background: <?php echo e($category->color ?? 'linear-gradient(135deg, #E50914 0%, #B20710 100%)'); ?>;">
                    ...
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-4 text-sm">
                            <span class="flex items-center gap-1 text-gray-600 dark:!text-text-secondary" style="font-family: 'Poppins', sans-serif; font-weight: 500;">
                                ...
                                <?php echo e(number_format($category->articles_count ?? 0)); ?> articles
                            </span>
                        </div>
                    </div>
                    
                    <!-- Latest Article Info -->
                    <?php if($category->articles->count() > 0 && $category->articles->first()): ?>
                        <?php
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="col-span-3 text-center py-16">
                ...
                <p class="text-gray-600 dark:!text-text-secondary text-lg mb-2" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                    <?php if($search): ?>
                        No categories found matching "<?php echo e($search); ?>"
                    <?php else: ?>
                        No categories found.
                    <?php endif; ?>
                </p>
                <?php if($search): ?>
                    <a href="<?php echo e(route('categories.index')); ?>" class="text-accent hover:text-accent-light font-semibold" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                        View All Categories
                    </a>
                <?php endif; ?>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox - Copy\resources\views/categories/index.blade.php ENDPATH**/ ?>