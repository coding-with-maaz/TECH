        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <ul class="hidden md:flex items-center gap-6 lg:gap-8">
                    ...
                    <li><a href="<?php echo e(route('movies.index')); ?>" class="text-gray-900 hover:text-accent transition-colors font-semibold dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Movies</a></li>
                    <li><a href="<?php echo e(route('tv-shows.index')); ?>" class="text-gray-900 hover:text-accent transition-colors font-semibold dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">TV Shows</a></li>
                    <li><a href="<?php echo e(route('cast.index')); ?>" class="text-gray-900 hover:text-accent transition-colors font-semibold dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Cast</a></li>
                    <li><a href="<?php echo e(route('upcoming')); ?>" class="text-gray-900 hover:text-accent transition-colors font-semibold dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Upcoming</a></li>
                    <li><a href="<?php echo e(route('completed')); ?>" class="text-gray-900 hover:text-accent transition-colors font-semibold dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">Completed</a></li>
                    ...
                    <li><a href="<?php echo e(route('dmca')); ?>" class="text-gray-900 hover:text-accent transition-colors font-semibold dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">DMCA</a></li>
                </ul>
