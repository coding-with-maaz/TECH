<?php $__env->startSection('title', $series->title . ' - Series - Tech Blog'); ?>
...
<div class="w-full px-4 sm:px-6 lg:px-8 xl:px-12 py-8">
    ...
    <nav class="mb-6" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 text-sm" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
            ...
            <li><a href="<?php echo e(route('series.index')); ?>" class="text-gray-600 hover:text-accent dark:!text-text-secondary transition-colors">Series</a></li>
            <li><span class="text-gray-400 dark:!text-text-tertiary">/</span></li>
            <li><span class="text-gray-900 dark:!text-white font-semibold"><?php echo e($series->title); ?></span></li>
        </ol>
    </nav>
                ...
                <div class="w-full p-6 md:p-8 text-white">
                    ...
                    <div class="flex flex-wrap gap-4 text-sm">
                        <div class="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                            ...
                            <span style="font-family: 'Poppins', sans-serif; font-weight: 600;"><?php echo e(number_format($seriesStats['total_articles'])); ?> Articles</span>
                        </div>
                        <div class="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span style="font-family: 'Poppins', sans-serif; font-weight: 600;"><?php echo e(number_format($seriesStats['total_views'])); ?> Views</span>
                        </div>
                        ...
                        <div class="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                            ...
                            <span style="font-family: 'Poppins', sans-serif; font-weight: 600;"><?php echo e($seriesStats['avg_reading_time']); ?> min avg</span>
                        </div>
                        <?php endif; ?>
                        <?php if($seriesStats['total_reading_time'] > 0): ?>
                        <div class="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span style="font-family: 'Poppins', sans-serif; font-weight: 600;"><?php echo e($seriesStats['total_reading_time']); ?> min total</span>
                        </div>
                        <?php endif; ?>
                        ...
                        <div class="flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                            ...
                            <span style="font-family: 'Poppins', sans-serif; font-weight: 600;"><?php echo e($series->author->name); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div class="flex-1 p-6">
                                <div class="flex items-center gap-3 mb-3 flex-wrap">
                                    ...
                                    <?php if($article->category): ?>
                                        <a href="<?php echo e(route('categories.show', $article->category->slug)); ?>" class="px-3 py-1 bg-accent text-white rounded-full text-xs font-semibold hover:bg-accent-light transition-colors" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                                ...
                                <div class="flex items-center gap-4 text-sm text-gray-500 dark:!text-text-secondary flex-wrap" style="font-family: 'Poppins', sans-serif; font-weight: 400;">
                                    ...
                                    <?php if($article->author): ?>
                                        <span>•</span>
                                        <a href="<?php echo e(route('profile.show', $article->author->username ?? $article->author->id)); ?>" class="hover:text-accent transition-colors">
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white border border-gray-200 p-6 mb-6 rounded-lg dark:!bg-bg-card dark:!border-border-secondary">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-lg font-bold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($seriesStats['total_articles'])); ?></span>
                    </div>
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-lg font-bold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e(number_format($seriesStats['total_views'])); ?></span>
                    </div>
                    <?php if($seriesStats['avg_reading_time'] > 0): ?>
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-lg font-bold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e($seriesStats['avg_reading_time']); ?> min</span>
                    </div>
                    <?php endif; ?>
                    <?php if($seriesStats['total_reading_time'] > 0): ?>
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-lg font-bold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 700;"><?php echo e($seriesStats['total_reading_time']); ?> min</span>
                    </div>
                    <?php endif; ?>
                    <?php if($seriesStats['latest_article']): ?>
                    <div class="pt-4 border-t border-gray-200 dark:!border-border-primary">
                        ...
                        <p class="text-sm font-semibold text-gray-900 dark:!text-white" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                            <?php echo e($seriesStats['latest_article']->published_at ? $seriesStats['latest_article']->published_at->format('M d, Y') : $seriesStats['latest_article']->created_at->format('M d, Y')); ?>
            ...
            <div class="bg-white border border-gray-200 p-6 mb-6 rounded-lg dark:!bg-bg-card dark:!border-border-secondary">
                ...
                <div class="space-y-4">
                    <?php $__currentLoopData = $popularInSeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $popularArticle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="bg-white border border-gray-200 p-6 mb-6 rounded-lg dark:!bg-bg-card dark:!border-border-secondary">
                ...
                <div class="space-y-2">
                    <?php $__currentLoopData = $relatedSeries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relatedSer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('series.show', $relatedSer->slug)); ?>" class="flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-all dark:!hover:bg-bg-card-hover group">
            ...
            <div class="bg-white border border-gray-200 p-6 rounded-lg dark:!bg-bg-card dark:!border-border-secondary">
                ...
                <div class="space-y-2">
                    <?php $__currentLoopData = $categories->take(10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('categories.show', $cat->slug)); ?>" class="flex items-center justify-between p-2 hover:bg-gray-50 rounded-lg transition-all dark:!hover:bg-bg-card-hover group">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox - Copy\resources\views/series/show.blade.php ENDPATH**/ ?>