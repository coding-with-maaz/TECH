        ...
        <form action="<?php echo e(route('admin.articles.store')); ?>" method="POST">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Series Order -->
                    <div id="series_order_field" style="display: <?php echo e(old('series_id') ? 'block' : 'none'); ?>;">
                        <label class="block text-sm font-semibold text-gray-700 dark:!text-white mb-2" style="font-family: 'Poppins', sans-serif; font-weight: 600;">
                            Order in Series
                        </label>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\k\Desktop\Nazaarabox - Copy\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>